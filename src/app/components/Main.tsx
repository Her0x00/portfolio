    ...
    <div className='flex justify-center items-center h-screen text-black gap-4'>
      <div className='flex flex-col'>
        ...
        <div className='flex gap-6 mt-4'>
          <div>
            <button className='border border-black bg-black text-white h-9 px-3 hover:bg-gray-800 rounded-md transition ease-in-out duration-250'>View My Work</button>
          </div>
          <div>
            <button 
              className='border border-gray-400 text-black h-9 px-3 rounded-md hover:bg-gray-200 transition ease-in-out duration-250'>GitHub Profile</button>
          </div>
        </div>
        </div>
      </div>
